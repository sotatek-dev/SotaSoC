...
set_property PACKAGE_PIN L21 [get_ports {ui_in[4]}]
...
set_property PACKAGE_PIN K22 [get_ports {ui_in[6]}]
...
set_property PULLTYPE PULLDOWN [get_ports {ui_in[7]}]
...
set_property PACKAGE_PIN M18 [get_ports {uo_out[7]}]
